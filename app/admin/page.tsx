...
const S = {
  pageTitle: { fontFamily: "'Share Tech Mono'", fontSize: 11, color: '#4a5a70', letterSpacing: '3px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 } as React.CSSProperties,
  statRow:   { display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 16 } as React.CSSProperties,
  card:      { background: '#111520', border: '1px solid #1a2230', borderRadius: 6, padding: '12px 14px' } as React.CSSProperties,
  label:     { fontFamily: "'Share Tech Mono'", fontSize: 9, color: '#4a5a70', letterSpacing: '1px', marginBottom: 6 } as React.CSSProperties,
  val:       { fontFamily: "'Share Tech Mono'", fontSize: 22, fontWeight: 700, lineHeight: 1 } as React.CSSProperties,
  sub:       { fontFamily: "'Share Tech Mono'", fontSize: 9, color: '#4a5a70', marginTop: 4 } as React.CSSProperties,
  panel:     { background: '#111520', border: '1px solid #1a2230', borderRadius: 6, overflow: 'hidden', marginBottom: 12 } as React.CSSProperties,
  panelHead: { padding: '10px 14px', borderBottom: '1px solid #1a2230', fontFamily: "'Share Tech Mono'", fontSize: 10, color: '#4a5a70', letterSpacing: '2px' } as React.CSSProperties,
  panelBody: { padding: 14 } as React.CSSProperties,
  feedItem:  { padding: '7px 0', borderBottom: '1px solid #1a2230', fontFamily: "'Share Tech Mono'", fontSize: 11, display: 'flex', alignItems: 'flex-start', gap: 8 } as React.CSSProperties,
  dot:       (color: string) => ({ width: 5, height: 5, borderRadius: '50%', background: color, flexShrink: 0, marginTop: 3 }) as React.CSSProperties,
}
...
export default function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div style={{ fontFamily: "'Share Tech Mono'", color: '#4a5a70', fontSize: 11, padding: 20 }}>
        LOADING STATS...
      </div>
    )
  }
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          ...
          <div style={S.panelBody}>
            <div style={S.feedItem}>
              ...
              <div>
                ...
                <div style={{ color: '#4a5a70', fontSize: 9, marginTop: 2 }}>
        ...
        <div style={S.panel}>
          ...
          <div style={S.panelBody}>
            {feed.length === 0 ? (
              <div style={{ color: '#4a5a70', fontSize: 10, fontFamily: "'Share Tech Mono'" }}>
                No feed items yet
              </div>
            ) : (
              feed.map((item) => (
